      ...
      <PageDelimiter flex={1}>
        ...
        <VStack space={4} mt={4}>
            ...
            <VStack space={3}>
              ...
              <HStack space={2} alignItems="center">
                ...
                <Text fontSize="sm" color="coolGray.600">
                  {t('ADOPTION_REQUESTS.OWNER.DETAIL.REQUESTED_ON')}:{' '}
          ...
          <Box bg="white" borderRadius="xl" shadow={2} p={4}>
            <Text fontSize="lg" fontWeight="bold" color="coolGray.800" mb={3}>
              {t('ADOPTION_REQUESTS.OWNER.DETAIL.ADOPTER_INFO')}
            </Text>
            ...
            <VStack space={3}>
              ...
              <Text fontSize="sm" color="coolGray.500" italic>
                {t('ADOPTION_REQUESTS.OWNER.DETAIL.CONTACT_INFO_NOTICE')}
              </Text>
            </VStack>
          </Box>
        ...
        {request.status === AdoptionRequestStatus.PENDING && (
          <VStack space={2} mt="auto">
            ...
            >
              {t('ADOPTION_REQUESTS.OWNER.DETAIL.ACCEPT_REQUEST')}
            </Button>
            ...
            >
              {t('ADOPTION_REQUESTS.OWNER.DETAIL.DENY_REQUEST')}
            </Button>
          </VStack>
        )}
      </PageDelimiter>
